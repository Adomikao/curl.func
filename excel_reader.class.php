 ...
 * send a note to license@php.net so we can mail you a copy immediately.
  ...
  * $data->dump($row_numbers=false,$col_letters=false,$sheet=0,$table_class='excel') //显示所有内容
  * $data->val($row,$col) //获取 $row,$col的值
  * $data->val(10,'AZ')   //获取第十行 AZ的值
  * $data->val($row,$col,$sheet_index) //获取另一个表的值
  * $data->rowcount($sheet_index=0) //获取总行数
  * $data->colcount($sheet_index=0) //获取总列数
  * 
